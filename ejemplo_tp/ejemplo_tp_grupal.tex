...
\begin{proc}{redistribucionDeLosFrutos}{\In recursos : \TLista{\float}, \In cooperan : \TLista{\bool}}{\TLista{\float}}
	...
	\requiere{recursos > 0}
	\asegura{\paraTodo[]{i}{cooperan}{\IfThenElse{cooperan[i] = True}{recursos[i] = fondo \hspace{0.15cm} / \hspace{0.15cm} |cooperan|}{recursos[i] = recursos[old(i)] \hspace{0.15cm} +  \hspace{0.15cm} fondo \hspace{0.15cm} / \hspace{0.15cm} \neg sumaDeLosQueCooperan(cooperan)}}}
