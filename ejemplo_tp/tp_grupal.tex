...
% \ llama al proc del ejercicio 2, y asegura que el resultado de este ejercicio maximiza la siguiente expresión de la siguiente forma: res \req trayectorias[individuo[|trayectoria[individuo]|]]
