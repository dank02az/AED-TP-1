...
\begin{proc}{redistribucionDeLosFrutos}{\In recursos : \TLista{\float}, \In cooperan : \TLista{\bool}}{\TLista{\float}}
	...
	\asegura {\\
 |res| = |cooperan| \yLuego \\ 
 \paraTodo[unalinea]{i}{\ent} {0 \leq i \leq |res|  \yLuego cooperan[i] = True \implicaLuego res[i] = \frac{fondo(recursos,cooperan)}{|cooperan|} }  \yLuego \\ \paraTodo[unalinea]{i}{\ent} {0 \leq i \leq |res| \yLuego cooperan[i] = False \implicaLuego res[i] = recursos[i] + \frac{fondo(recursos,cooperan)}{|cooperan|}} \\
 }
